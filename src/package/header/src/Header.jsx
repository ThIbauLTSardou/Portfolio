    ...
    <>
      ...
      <section className="header">
        <div className="header_sidebar">
          ...
          <a href="https://open.spotify.com/playlist/37i9dQZF1E8I85RZzQKYaw?si=bfeaaf59ca90474f" target="_blank" rel="noreferrer" className="header_sidebar_link">
