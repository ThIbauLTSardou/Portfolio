...
const stack = [
  { name: "React",       icon: `${ICON_BASE}/react/react-original.svg`,           col: 7,  line: 1, fromDir: "top"    },
  { name: "HTML",        icon: `${ICON_BASE}/html5/html5-original.svg`,            col: 78, line: 4, fromDir: "bottom" },
  { name: "CSS",         icon: `${ICON_BASE}/css3/css3-original.svg`,              col: 18, line: 1, fromDir: "top"    },
  { name: "JavaScript",  icon: `${ICON_BASE}/javascript/javascript-original.svg`,  col: 42, line: 3, fromDir: "bottom" },
  { name: "Node.js",     icon: `${ICON_BASE}/nodejs/nodejs-original.svg`,          col: 88, line: 2, fromDir: "top"    },
  { name: "Express",     icon: `${ICON_BASE}/express/express-original.svg`,        col: 31, line: 4, fromDir: "bottom" },
  { name: "PHP",         icon: `${ICON_BASE}/php/php-original.svg`,                col: 63, line: 2, fromDir: "top"    },
  { name: "Git",         icon: `${ICON_BASE}/git/git-original.svg`,                col: 52, line: 1, fromDir: "bottom" },
  { name: "Figma",       icon: `${ICON_BASE}/figma/figma-original.svg`,            col: 24, line: 3, fromDir: "top"    },
  { name: "VS Code",     icon: `${ICON_BASE}/vscode/vscode-original.svg`,          col: 83, line: 3, fromDir: "bottom" },
  { name: "Vite",        icon: `${ICON_BASE}/vitejs/vitejs-original.svg`,          col: 71, line: 4, fromDir: "top"    },
  { name: "Supabase",    icon: `${ICON_BASE}/supabase/supabase-original.svg`,      col: 38, line: 2, fromDir: "bottom" },
  { name: "Claude Code", icon: "https://avatars.githubusercontent.com/u/76263028?s=48", col: 57, line: 4, fromDir: "top" },
  { name: "SCSS",        icon: `${ICON_BASE}/sass/sass-original.svg`,              col: 13, line: 4, fromDir: "bottom" },
  { name: "Bulma",       icon: `${ICON_BASE}/bulma/bulma-plain.svg`,               col: 46, line: 2, fromDir: "top"    },
];
