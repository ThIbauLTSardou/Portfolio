...
const EMAIL = "thibaultsardou1@gmail.com";
    ...
    <footer className="footer">
      <div className="footer_top">
        <div className="footer_left">
          ...
          <a href={`mailto:${EMAIL}`} className="footer_email">
            {EMAIL}
            <button className="footer_email_icon" onClick={handleCopy} title={copied ? "Copié !" : "Copier l'adresse"}>
              {copied ? (
